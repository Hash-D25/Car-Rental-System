document.addEventListener("DOMContentLoaded", () => {
  const API_URL = "https://crs-server.zeabur.app/api/auth";
...
async function handleRegister(e) {
  ...
  try {
    const response = await fetch(
      `https://crs-server.zeabur.app/api/auth/register`,
      {
        method: "POST",
...
async function handleLogin(e) {
  ...
  try {
    const response = await fetch(
      `https://crs-server.zeabur.app/api/auth/login`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function loadUserProfile() {
  ...
  try {
    const response = await fetch(
      "https://crs-server.zeabur.app/api/auth/profile",
      {
    ...
    if (response.ok) {
      ...
      document.getElementById("view-address").textContent =
        user.address || "N/A";
      document.getElementById("view-licenseNumber").textContent =
...
async function handlePasswordChange(e) {
  ...
  try {
    const response = await fetch(
      "https://crs-server.zeabur.app/api/auth/change-password",
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
async function loadUserDashboardStats() {
  ...
  try {
    const response = await fetch(
      "https://crs-server.zeabur.app/api/auth/profile/stats",
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
    ...
    if (response.ok) {
      ...
      document.getElementById("rented-history-count").textContent =
        stats.rentedHistoryCount;
